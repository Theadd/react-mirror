...
var Replicator = (function (_Component) {
  ...
  _createClass(Replicator, [{
    ...
    value: function update() {
      ...
      var master = arguments[0] === undefined ? null : arguments[0];
      ...
      if (this._master != null) {
        (function () {
          ...
          _react2['default'].render(_this2._element, _this2._imprint);
        ...
        _react2['default'].render(this._element, this._imprint);
      }
      this.observe(true);
    }
  }, {
    ...
    value: function getDOMNode(sync) {
      return ((sync || sync == null && !this._imprint.children.length) && _react2['default'].render(this._element, this._imprint), this._imprint);
    }
  }, {
    key: 'master',
    get: function get() {
