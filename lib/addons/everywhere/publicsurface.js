...
var PublicSurface = (function (_Component) {
  function PublicSurface(props, context) {
    ...
    //this._id = (typeof props.id === 'string' && props.id.length) ? props.id : null
  ...
  _createClass(PublicSurface, [{
    ...
    /*getChildContext () {
      return {
        parentId: 'THIS IS P_ARENT ID (' + this.context.parentId + ')'
      }
    }*/
    ...
    value: function _getPublicParams(_ref, _ref2) {
      ...
      return (id != null && (parentId === void 0 && (_parentId === id && ( //IS A GROUP
      parentId = _prev_parentId, 1) || ( //IS NOT A GROUP
      parentId = _parentId, 1)), 1) || //ID IS NULL
      parentId === void 0 && (parentId = _parentId, 1), { id: id, parentId: parentId });
    }
  }, {
    key: 'render',
