...
var Surface = (function (_Component) {
  ...
  _createClass(Surface, [{
    ...
    value: function add(mirror) {
      this.refs.repl.add(_reactDom2['default'].findDOMNode(mirror));
    }
  }, {
    key: 'remove',
    value: function remove(mirror) {
      this.refs.repl.remove(_reactDom2['default'].findDOMNode(mirror));
    }
  }, {
    key: 'update',
    value: function update() {
      var children = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
      var keepInSync = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
    ...
    value: function getDOMNode() {
      var sync = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
    ...
    set: function set(mirror) {
      mirror && (this.refs.repl.master = _reactDom2['default'].findDOMNode(mirror));
    }
  }]);
